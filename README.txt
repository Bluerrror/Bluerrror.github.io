Welcome to My Personal Website & Learning Hub
...
Install dependencies (if applicable):npm install  # For JavaScript-based website
pip install -r requirements.txt  # For Python-based scripts


Run the website locally:npm start  # Or the appropriate command for your framework
...
Open Jupyter notebooks using:jupyter notebook
